...
int main(int argc, char **argv) {
	...
	cout << "The item at the front is: " << listOfInts.Front() << endl << endl;
	
	cout << "The item at the back is: " << listOfInts.Back() << endl << endl;
	 
	if (!(listOfInts.IsEmpty())) {
		listOfInts.Pop_front();
		cout << "Popped from the front, listOfInts now contains " << listOfInts.Length() << " elements. " << endl;
		cout << "Specifically: ";
		listOfInts.Print();
		cout << endl;
		cout << "Backwards that is ... ";
